export const DEVICE_REGISTER = "api/mobile/register/new";
export const STUDENT_LIST = "api/mobile/register/hebe";

export const DATA_ROOT = "api/mobile";
...
export const DATA_LUCKY_NUMBER = "school/lucky";

export const DATA_EXAM = "exam";
export const DATA_GRADE = "grade";
export const DATA_GRADE_SUMMARY = "grade/summary";
export const DATA_GRADE_AVERAGE = "grade/average";
